...
public class EffectManager {
	...
	public enum AvailableEffects {
		BULLET_EXPLOSION, POWERUP_TAKE, HIT_BLOOD_E, HIT_BLOOD_N, HIT_BLOOD_NE, HIT_BLOOD_NW, HIT_BLOOD_S, HIT_BLOOD_SE, HIT_BLOOD_SW, HIT_BLOOD_W, DEATH_BLOOD_N, DEATH_BLOOD_S, DEATH_BLOOD_W, DEATH_BLOOD_E, SMOKE,
	}

	private Array<Effect> activeEffects = new Array<Effect>();
	private Texture explosionTexture, powerupTexture, smokeTexture;
	...
	public EffectManager() {
		...
		smokeTexture = new Texture(Gdx.files.internal("data/effects/fx_enemydie_64.png"));
	...
	public void addEffect(AvailableEffects effect, float posX, float posY) {
		...
		switch (effect) {
			...
			case POWERUP_TAKE:
				...
				break;
			case SMOKE:
				activeEffects.add(new Effect(smokeTexture, 15, 1, 0.05f, 0, posX, posY));
				break;
